...
function SpaceBg({ dark }: { dark: boolean }) {
  ...
  const arc = dark
    ? `rgba(212,175,55,0.55)` : `rgba(140,95,0,0.50)`;
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        boxShadow: dark
          ? `0 0 12px rgba(212,175,55,0.45), 0 0 35px rgba(212,175,55,0.22), 0 0 80px rgba(212,175,55,0.08)`
      ...
      <div style={{
        ...
        transform: "translateX(-50%)", borderRadius: "50%",
        boxShadow: dark
          ? `inset 0 3px 40px rgba(212,175,55,0.18), inset 0 1px 80px rgba(255,220,60,0.08)`
      ...
      <div style={{
        ...
        background: dark
          ? `radial-gradient(circle, rgba(255,255,220,1) 0%, rgba(255,235,90,0.85) 4%, rgba(212,175,55,0.55) 12%, rgba(212,175,55,0.18) 35%, transparent 65%)`
