...
function SpaceBg({ dark }: { dark: boolean }) {
  ...
  return (
    <div style={{ position: "fixed", inset: 0, overflow: "hidden", pointerEvents: "none", zIndex: 0, background: dark ? "#000" : "#0a0703" }}>
      ...
      {/* Wing soft outer glow – wider spread */}
      <div style={{
        position: "absolute", inset: 0,
        background: `conic-gradient(from 0deg at 50% 57%,
          transparent 0deg,
      ...
      {/* ── Planet arc (giant circle, top edge visible) ── */}
      <div style={{
        position: "absolute",
        left: "50%",
        top: "57%",
      ...
      {/* Atmosphere glow strip along arc */}
      <div style={{
        position: "absolute",
        left: "50%",
        top: "57%",
        ...
        >
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "0.4rem" }}>
            ...
            <input
              ...
              style={{ width: "100%", boxSizing: "border-box" as const, background: inputBg, border: `1px solid ${inputBorder}`, borderRadius: "0.875rem", padding: "0.8125rem 1rem", fontSize: "0.9rem", color: "#ffffff", outline: "none", transition: "border-color 0.2s, background 0.2s" }}
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "0.4rem" }}>
            ...
            <div style={{ position: "relative" }}>
              <input
                ...
                style={{ width: "100%", boxSizing: "border-box" as const, background: inputBg, border: `1px solid ${inputBorder}`, borderRadius: "0.875rem", padding: "0.8125rem 3rem 0.8125rem 1rem", fontSize: "0.9rem", color: "#ffffff", outline: "none", transition: "border-color 0.2s, background 0.2s" }}
                onFocus={(e) => { e.target.style.borderColor = "#D4AF37"; e.target.style.background = inputFocusBg; }}
                onBlur={(e) => { e.target.style.borderColor = inputBorder; e.target.style.background = inputBg; }}
              />
