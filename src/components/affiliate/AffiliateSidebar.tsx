...
export default function AffiliateSidebar() {
  ...
  return (
    <>
      <style>{`
        .aff-sidebar     { position:fixed;left:0;top:0;height:100%;width:16rem;display:flex;flex-direction:column;z-index:40; }
        .aff-bottom-nav  { display:none; }
        @media (max-width:768px) {
          .aff-sidebar    { display:none !important; }
          .aff-bottom-nav { display:flex !important; }
        }
      `}</style>
      ...
      <aside className="aff-sidebar" style={{
        ...
        boxShadow: dark ? "4px 0 24px rgba(0,0,0,0.35)" : "4px 0 24px rgba(0,0,0,0.06), inset -1px 0 0 rgba(255,255,255,0.60)",
      }}>
      ...
      {/* ── MOBILE BOTTOM NAV ── */}
      <nav className="aff-bottom-nav" style={{
